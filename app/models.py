...
class Historico(models.Model):
    ...
    doador = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name='historico_doacoes')
    adotante = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name='historico_adocoes')
    data = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return f"{self.item} adotado por {self.adotante}"